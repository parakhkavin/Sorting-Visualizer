...
def draw(draw_info, algo_name, ascending):
    ...
    title = draw_info.LARGE_FONT.render(
        f"{algo_name} - {'Ascending' if ascending else 'Descending'}", 1,
        draw_info.GREEN)
    ...
    sorting = draw_info.FONT.render(
        "I - Insertion Sort | B - Bubble Sort | S - Selection Sort", 1,
        draw_info.BLACK)
    draw_info.window.blit(sorting,
...
def draw_list(draw_info, color_positions={}, clear_bg=False):
    ...
    for i, val in enumerate(lst):
        ...
        y = draw_info.height - (val -
                                draw_info.min_val) * draw_info.block_height
    ...
    for i in range(0, len(lst)):
        ...
        for j in range(i + 1, len(lst)):
            ...
            if (lst[j] < lst[min_index]
                    and ascending) or (lst[j] > lst[min_index]
                                       and not ascending):
                min_index = j
